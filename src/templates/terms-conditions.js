...
class TermsAndConditionsTemplate extends React.Component {
	render() {
		...
		return (
			<Layout location={this.props.location} title={siteTitle} language={language}>
				<Container>
					<FlexArticle>
						<h1>Welcome to Tsukie</h1>
						<p>These terms and conditions outline the rules and regulations for the use of Tsukie's Website.</p><br/>
						<span style={{ textTransform: "capitalize" }}>Tsukie</span> is located at:<br/>
						<a href="https://tsukie.com">https://tsukie.com</a>
						...
						<h2>License</h2>
						<p>Unless otherwise stated, Tsukie and/or it’s licensors own the intellectual property rights for
							all material on Tsukie. All intellectual property rights are reserved. You may view and/or print
							pages from https://tsukie.com for your own personal use subject to restrictions set in these terms and
							conditions.</p>
						<p>You must not:</p>
						<ul>
							<li>Republish material from https://tsukie.com</li>
							<li>Sell, rent or sub-license material from https://tsukie.com</li>
							<li>Reproduce, duplicate or copy material from https://tsukie.com</li>
						</ul>
						<p>Redistribute content from Tsukie (unless content is specifically made for redistribution).</p>
						<h2>User Comments</h2>
						<ul>
							<li>This Agreement shall begin on the date hereof.</li>
							<li>Certain parts of this website offer the opportunity for users to post and exchange opinions,
								information,
								material and data ('Comments') in areas of the website. Tsukie does not screen, edit, publish
								or review Comments prior to their appearance on the website and Comments do not reflect the views or
								opinions ofTsukie, its agents or affiliates. Comments reflect the view and opinion of the
								person who posts such view or opinion. To the extent permitted by applicable laws Tsukieshall
							...
							<li>Tsukiereserves the right to monitor all Comments and to remove any Comments which it considers
							...
							<li>You hereby grant to Tsukie a non-exclusive royalty-free license to use, reproduce,
						...
						<p>We will approve link requests from these organizations if we determine that: (a) the link would not
							reflect unfavorably on us or our accredited businesses (for example, trade associations or other organizations
							representing inherently suspect types of business, such as work-at-home opportunities, shall not be
							allowed to link); (b)the organization does not have an unsatisfactory record with us; (c) the benefit to us from
							the visibility associated with the hyperlink outweighs the absence of Tsukie's name; and (d) where the
						...
						<p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our
							...
							<a href="mailto:minhnh.da@gmail.com">minhnh.da@gmail.com</a>.
						...
						<p>No use of Tsukie’s logo or other artwork will be allowed for linking absent a trademark license
							agreement.</p>
						<h2>Iframes</h2>
...
export const pageQuery = graphql`
	query QueryForSidebarInToS($language: String!) {
		site {
			siteMetadata {
				title
				author
